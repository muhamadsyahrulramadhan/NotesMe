...
import com.example.notesme.adapter.NoteAdapter;
import com.example.notesme.db.NoteHelper;
...
import static com.example.notesme.FormAddUpdateActivity.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.fab_add){
            Intent i = new Intent(MainActivity.this, FormAddUpdateActivity.class);
            startActivityForResult(i, FormAddUpdateActivity.REQUEST_ADD);
        }
    }
